...
This site was built using React.js and Scss. The challenge was to build out a countdown timer and style it as close to the design as possible. 

# To run the app 

##Use a package manager (I chose Yarn)
